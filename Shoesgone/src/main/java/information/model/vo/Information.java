...
public class Information implements java.io.Serializable {
	...
	public Information(int userNo, String userName, String userId, String userPwd, String email, String phone,
			String address, int shoesSize, int point, String mgr, String bankName, String accountNo, String loginOk) {
		super();
		this.userNo = userNo;
	...
	public String toString() {
		return "Information [userNo=" + userNo + ", userName=" + userName + ", userId=" + userId + ", userPwd="
				...
				+ shoesSize + ", point=" + point + ", mgr=" + mgr + ", bankName=" + bankName + ", accountNo="
				+ accountNo + ", loginOk=" + loginOk + "]";
	}
