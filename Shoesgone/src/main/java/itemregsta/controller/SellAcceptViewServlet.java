...
/**
 * Servlet implementation class SellAcceptViewServlet
 */
@WebServlet("/sellaccept")
public class SellAcceptViewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SellAcceptViewServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(item != null && plist != null) {
			view = request.getRequestDispatcher("views/sellPage/sell_accept.jsp");
