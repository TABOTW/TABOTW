...
/**
 * Servlet implementation class GalleryFileDownloadServlet
 */
@WebServlet("/galleryfdown")
public class GalleryFileDownloadServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GalleryFileDownloadServlet() {
		super();
