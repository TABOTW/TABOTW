 ...
 */
@WebServlet("/tenderbuy")
public class ChangeToTenderBuy extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ChangeToTenderBuy() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 즉시 구매에서 구매 입찰 화면으로 전환 처리용 컨트롤러
		// 1. 즉시 구매에서 객체 받아오기
		...
		if(item != null && plist != null) {
			view = request.getRequestDispatcher("views/buyPage/tender_buy.jsp");
