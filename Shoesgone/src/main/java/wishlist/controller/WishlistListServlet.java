...
public class WishlistListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = wservice.getListCount(userNo);// 서비스 객체 메소드 실행하고 결과받기
		...
		ArrayList<Wishlist> list = wservice.selectList(startRow, endRow, userNo);
		...
		RequestDispatcher view = null;
			...
			view = request.getRequestDispatcher("views/myPage/wishlist.jsp");
