					...
					<div class="login_form_inner">
						<form class="row login_form" id="contactForm" novalidate="novalidate">
							<div class="col-md-12 form-group">
								<h6 style="text-align: center; color: black;">임시 비밀번호를 전송하였습니다.</h6>
								<h6 style="text-align: center; color: black;">전송 받은 임시 비밀번호로 로그인해주세요.</h6>
							</div>
							<div class="col-md-12 form-group">
								<p style="font-size: 15px; color: black; font-weight: bold;"><%= loginMember.getUserPwd() %></p>
								<% session.invalidate(); %>
 							</div>
							<div class="col-md-12 form-group">
