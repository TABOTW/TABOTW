    ...
    <table class="th" border="1" summary="" align="center" width="960px">
        ...
        <tbody class="{$list_display|display}">
            <tr>
              <td class="number">
                    {$order_date}
                    <p><a href="orderdetail.jsp"class="line">[{$order_id}]</a></p>
                </td>
                <td class="product"><strong><a href="#">{$product_name}</strong> </a></td>
                <td class="price"><strong>{$product_price}</strong><span>({$product_count}개)</span></td>
                <td class="deliveryprice"><strong></strong></td>
                <td class="state">{$cur_state}</td>
            </tr>
            <tr>
             <td class="number">
                    {$order_date}
...
<center><a href="#" class="genric-btn primary">목록보기</a></center>
<hr>
    <br><br><br>
</div>
</section>
