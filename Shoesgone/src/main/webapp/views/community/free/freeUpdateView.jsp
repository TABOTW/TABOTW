<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="community.free.model.vo.Free" %>
<%
		...
		<div class="container">
			...
			<div class="billing_details">
				<div class="row">
					<div class="col-lg-8">
						<h3>글 수정하기</h3>
						<form class="row contact_form" action="/Shoesgone/menubarsearch?menu=freeupdate" method="post"
							...
							<div class="button-group-area mt-40">
								<tr>
									<th colspan="2">
										...
										<input type="button" value="목록" onclick="javascript:location.href='/Shoesgone/menubarsearch?menu=freepage&page=1'; return false;">
									</th>
								</tr>
							</div>
							...
							<div class="col-md-12 form-group p_star">
								<tr>
									<th>첨부파일</th>
									<td>
										<% if (free.getFreeOriginalFilename() != null) { %> 
											<%= free.getFreeOriginalFilename()%> &nbsp; 
