<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="community.gallery.model.vo.Gallery" %>
<%
		...
		<div class="container">
			...
			<div class="billing_details">
				<div class="row">
					<div class="col-lg-8">
						<h3>글 수정하기</h3>
						<form class="row contact_form" action="/Shoesgone/freeupdate" method="post"
							...
							<div class="col-md-12 form-group p_star">
								<tr>
									<th>첨부파일</th>
									<td>
										<% if (gallery.getGalleryOriginalFilename() != null) { %> 
											<%= gallery.getGalleryOriginalFilename()%> &nbsp; 
