...
<%
	...
	ArrayList reviewList = (ArrayList) request.getAttribute("list");
					...
					<div class="progress-table-wrap">
						<div class="progress-table">
							...
							<div class="table-row">
								...
								<div class="boardtitle"><%= review.getReviewTitle() %></div>
								<div class="register"><%= review.getReviewWriter() %></div>
								<div class="registdate"><%= review.getReviewDate()%></div>
								<div class="hitcount"><%= review.getReviewReadCount() %></div>
							</div>
							<%
								}
							%>
