<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="community.review.model.vo.Review"%>
				...
				<div class="table-responsive">
					<table class="table">
						<tr>
							...
							<th width="10%">제목</th>
							<td width="60%" colspan="3"><%= review.getReviewTitle() %></td><!-- 제목 -->
							<th width="10%">번호</th>
							<td width="5%"><%= review.getReviewNo() %></td> <!-- 번호 -->
						</tr>
						
						<tr>
							<th width="10%">작성자</th>
							<td width="10%"><%= review.getReviewWriter() %></td>
							<th width="10%">작성일</th>
							<td width="15%"><%= review.getReviewDate()%></td> <!-- 작성일  -->
							<th>조회수</th>
							<td width=""><%= review.getReviewReadCount() %></td>
						</tr>
						<tr>
						...
						<tr>
							<th colspan="1">내용</th>
							<th colspan="5"><%= review.getReviewContent() %></th>
						</tr>
						<tr align="center">
						<th colspan="6">
							<button href="#" class="genric-btn primary small">신고 </button>
							<button href="#" class="genric-btn primary small">추천 </button>
							<button onclick="javascript:location.href='/Shoesgone/menubarsearch?menu=reviewpage&page=<%= currentPage %>';" class="genric-btn primary small">목록</button>
							&nbsp;
							<% Login loginMemberInfo = (Login)session.getAttribute("loginMember");
							   if(loginMemberInfo != null &&
									review.getReviewWriter() == loginMember.getUserNo()) {
