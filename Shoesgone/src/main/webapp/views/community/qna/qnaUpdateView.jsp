<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="community.qna.model.vo.QnA" %>
<%
		...
		<div class="container">
			...
			<div class="billing_details">
				<div class="row">
					<div class="col-lg-8">
						<h3>글 수정하기</h3>
						<form class="row contact_form" action="/Shoesgone/menubarsearch?menu=qnaupdate" method="post"
