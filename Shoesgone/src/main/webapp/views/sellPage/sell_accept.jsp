		...
		<div class="container">
			<div class="row s_product_inner">
				...
				<div class="col-lg-5 offset-lg-1">
					<form action="/Shoesgone/menubarsearch?menu=regselect" method="get">
						<input type="hidden" name="menu" value="regselect">
						...
						<div class="s_product_text">
							...
							<div class="switch-wrap d-flex justify-content-between">
								<p>
									판매하려는 상품이 맞습니다. <input type="checkbox" id="primary-checkbox" required>
									<label for="primary-checkbox"></label><br>
									국내/해외에서 발매한 정품 상품입니다. <input type="checkbox" id="primary-checkbox" required> 
									<label for="primary-checkbox"></label><br>
									제조사에서 불량으로 인정하지 않는 기준은 하자로 판단하지 않습니다. <input type="checkbox" id="primary-checkbox" required>
									<label for="primary-checkbox"></label><br>
									슈즈곤의 최신 이용정책을 모두 확인하였으며, 판매를 계속합니다. <input type="checkbox" id="primary-checkbox" required>
