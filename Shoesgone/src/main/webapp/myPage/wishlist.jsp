...
<div module="Myshop_OrderOldHistoryList">
            ...
            <tr>
                <td>
                   <input type="checkbox" name="check" value="1" checked>
                    <p><a href="detail_old.html{$param_detail}" class="line"></a></p>
                </td>
                <td class="product"><strong><a href="#">{$product_name}</a></strong> </td>
                <td class="price"><strong></strong></td>
                
                <td class="state"><button type="submit" value="order" class="genric-btn primary-border small">주문</button></td>
            </tr>
            <tr>
                <td class="number">
                ...
                <td class="product"><strong><a href="#">{$product_name}</a></strong> <span></span></td>
                <td class="price"><strong></strong></td>
    ...
    <button type="submit" value="all-delete" class="genric-btn primary small">전체삭제</button></center>
   ...
   <div class="page_nation">
    ...
    <hr><center><a href="#" class="genric-btn primary">목록보기</a></center><br><br><br>
</div>
</section>
	<!--================Contact Area =================-->
